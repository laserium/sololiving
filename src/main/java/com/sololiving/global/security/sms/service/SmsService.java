...
public class SmsService {
    ...
    private final SmsRedisService smsCertificationService;
    ...
    public CompletableFuture<SingleMessageSentResponse> sendSms(String phone) {
        ...
        try {
            ...
            smsCertificationService.createSmsCertification(phone, randomNum);
    ...
    public boolean checkSms(String phone, String code) {
        String savedCertificationNumber = smsCertificationService.getSmsCertification(phone);
        if (savedCertificationNumber != null && savedCertificationNumber.equals(code)) {
            // 인증번호가 일치하면 Redis에서 삭제
            smsCertificationService.deleteSmsCertification(phone);
            return true;
        }
        return false;
    }
