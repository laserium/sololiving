...
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.UpdateUserAddressRequestDto;
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.UpdateUserBirthRequestDto;
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.UpdateUserContactRequestDto;
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.UpdateUserEmailRequestDto;
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.UpdateUserGenderRequestDto;
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.UpdateUserNicknameRequestDto;
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.UpdateUserPasswordRequestDto;
// import
// com.sololiving.domain.user.dto.request.UpdateUserRequestICDto.ValidateUpdateUserContactRequestDto;
...
// Mockito.times(1)).signUp(Mockito.any(SignUpRequestDto.class));
// }
...
// preprocessRequest(prettyPrint()),
// preprocessResponse(prettyPrint()),
// requestHeaders(headerWithName("Set-Cookie").description("accessToken=" +
// accessToken))));

// // verify
// Mockito.verify(cookieService, Mockito.times(1))
// .extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)); // 액세스
// 토큰 추출 확인
...
// 엑세스토큰")),
// pathParameters(
// parameterWithName("status").description("변경할 유저 상태 (ACTIVE, BLOCKED,
// WITHDRAWN)"))));

// // verify
// Mockito.verify(cookieService, Mockito.times(1))
// .extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class));
// Mockito.verify(userService, Mockito.times(1)).updateStatus(accessToken,
// status);
// }
...
// ValidateUpdateUserContactRequestDto.builder()
// .contact("01012345678")
// .build();
...
// // given
// String accessToken = "testAccessToken";
// UpdateUserContactRequestDto requestDto =
// UpdateUserContactRequestDto.builder()
...
// Mockito.when(cookieService.extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)))
// .thenReturn(accessToken);
// Mockito.doNothing().when(userService).updateUserContact(accessToken,
// requestDto);
...
// Mockito.when(cookieService.extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)))
// .thenReturn(accessToken);
// Mockito.doNothing().when(userService).sendUpdateNewEmailRequest(accessToken,
// requestDto);
...
// UpdateUserPasswordRequestDto.builder()
...
// Mockito.when(cookieService.extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)))
// .thenReturn(accessToken);
// Mockito.doNothing().when(userService).updateUserPassword(accessToken,
// requestDto);
...
// UpdateUserNicknameRequestDto.builder()
...
// Mockito.when(cookieService.extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)))
// .thenReturn(accessToken);
// Mockito.doNothing().when(userService).updateUserNickname(accessToken,
// requestDto);
...
// Mockito.when(cookieService.extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)))
// .thenReturn(accessToken);
// Mockito.doNothing().when(userService).updateUserGender(accessToken,
// requestDto);
...
// UpdateUserAddressRequestDto.builder()
...
// Mockito.when(cookieService.extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)))
// .thenReturn(accessToken);
// Mockito.doNothing().when(userService).updateUserAddress(accessToken,
// requestDto);
...
// Mockito.when(cookieService.extractAccessTokenFromCookie(Mockito.any(HttpServletRequest.class)))
// .thenReturn(accessToken);
// Mockito.doNothing().when(userService).updateUserBirth(accessToken,
// requestDto);
